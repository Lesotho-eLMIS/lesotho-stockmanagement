...
@RestController
@RequestMapping("/api/v2/stockCardSummariesResolv")
public class StockCardSummariesResolvV2Controller {

  private static final Logger LOGGER =
      LoggerFactory.getLogger(StockCardSummariesResolvV2Controller.class);

  @Autowired
  private StockCardSummariesService stockCardSummariesService;

  @Autowired
  private StockCardSummariesResolvV2DtoBuilder stockCardSummariesResolvV2DtoBuilder;
   ...
   */
  @GetMapping
  public Page<StockCardSummaryResolvV2Dto> getStockCardSummaries(
    ...
    List<StockCardSummaryResolvV2Dto> dtos = stockCardSummariesResolvV2DtoBuilder.build(
    ...
    Page<StockCardSummaryResolvV2Dto> page = Pagination.getPage(dtos, pageable);
